...
# --- Parameter to curve the screen, set by LivingObject ---
...
func apply_settings(settings: Dictionary) -> void:
	if settings.has("auto_pause_camera_distance"):
		auto_pause_camera_distance = float(settings["auto_pause_camera_distance"])

Per aprire Godot (macOS): apri la cartella `mac/` e fai doppio click su **Godot.app**. Se macOS blocca l’app (“sviluppatore non identificato”), fai **tasto destro → Apri → Apri** (solo la prima volta). Poi, in Godot premi **Importa**, seleziona la cartella `lcp-editor`, quindi **Importa e Modifica** (o **Importa**, a seconda della versione).

# Guida Curatori — Living Culture Platform Editor v1.0 (Godot) - 23.02.2026 (macOS)
...
- **Doppio click** su un elemento:
  ...
  - l’azione è undoabile: **⌘Z** ripristina
...
Undo:
- il riposizionamento è undoabile con **⌘Z**.
...
8) Salva la scena con **⌘S**, la troverai nella cartella `curated_scenes` del progetto. Eventualmente, puoi premere con il tasto destro sul nome della scena (in alto a sinistra es. `env_1687_2026...`) e premere “salva la scena come...” per rinominarla come preferisci.
